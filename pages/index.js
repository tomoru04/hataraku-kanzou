          ...
          <div className="md:w-[800px] mx-auto">
            ...
            <div className="text-center rounded-lg border-2 border-[#be123c] py-8 font-bold m-4 md:m-8 w-[340px] md:w-auto mx-auto">
              ...
              <div className="flex flex-col mt-4 px-6 md:px-16">
                <a className="bg-[#be123c] text-white mb-2 py-2 px-4 rounded-3xl hover:bg-pink-900" href="https://www.jsh.or.jp/medical/nara_sengen/ippan.html">
                  詳しく知りたい方はこちら
                </a>
        ...
        <footer className="text-center bg-[#be123c] text-white py-4">
          <div className="w-[310px] md:w-[700px] mx-auto flex-wrap text-left">
            ...
            <div className="text-left flex-wrap">
              ...
              <p className="text-[12px] mb-1">© Taisho Pharmaceutical Co., Ltd. All Rights Reserved.</p>
              <p className="text-[12px] mb-1">
                大正製薬株式会社(以下、「当社」といいます)は細心の注意を払い当ウェブサイト(https://www.altover30.netドメインのウェブサイトを指します)に情報を掲載しておりますが、この情報の正確性および完全性を保証するものではありません。また、当社は予告なしに当ウェブサイト掲載情報・内容の変更や当ウェブサイトの公開一時停止・終了を行うことがあります。当社および当ウェブサイト掲載の団体は、利用者が当ウェブサイトの情報を用いて行う一切の行為について、何らの責任を負うものではありません。また、利用者が当ウェブサイトにをご利用されたことで生じた損害につき当社および当ウェブサイト掲載の団体としては、一切責任を負いかねますので御了承ください。
              </p>
              </div>
          </div>
        </footer>
